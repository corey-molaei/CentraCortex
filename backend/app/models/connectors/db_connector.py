...
class DBConnector(Base):
    ...
    connection_uri_encrypted: Mapped[str] = mapped_column(String(2048), nullable=False)
    table_allowlist: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False)
