...
class JiraConnector(Base):
    ...
    project_keys: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False)
    issue_types: Mapped[list[str]] = mapped_column(JSON, default=list, nullable=False)
    fields_mapping: Mapped[dict[str, Any]] = mapped_column(JSON, default=dict, nullable=False)
